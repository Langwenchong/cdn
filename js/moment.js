var requests_url = 'https://hexo-circle-of-friends-api-3-beryl.vercel.app/api'; //api地址
...
var data_handle = (nofollow,data, maxnumber) => {
  ...
  for (var month_item of datalist_slice) {
    ...
    for (var post_item of month_item[1]) {
      ...
      html_item += '<img onerror="this.onerror=null,this.src=&quot;https://fastly.jsdelivr.net/gh/Zfour/Butterfly-friend-poor-html/friendcircle/404.png&quot;"';
